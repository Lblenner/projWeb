...
export default class DialogConnectionNote extends React.Component<MyProps, MyState> {
    ...
    return (
      <div id="dialoguePopUp">
        ...
        <Dialog
          ...
          >
            <DialogTitle id="simple-dialog-title">Connectez-vous pour ajouter une note !</DialogTitle>
            <div id="login">
